...
#include "../lib/includes/core/memory/TrackingAllocator.h"
#include "../lib/includes/core/storage/string_hash.h"
...
TEST_F(TypesTest, StringObject_CreateAndGet) {
    auto str = StringObject(&db, "hello");
